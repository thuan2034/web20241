    ...
    <section className="flex flex-row-reverse border-b-2 border-gray-200 pb-8 md:flex-row md:gap-8">
      ...
      <div className="flex grow flex-col justify-between gap-3">
        <div className="flex flex-col gap-2">
          ...
          <div className="flex items-center gap-3">
            <ProfileFriendsSvg />
            <span className="text-gray-500">{`${followingCount} Đang theo dõi / ${followersCount} Người theo dõi`}</span>
          </div>
        </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="flex gap-2 rounded-2xl border-2 border-gray-200 p-2 md:gap-3 md:px-6 md:py-4">
          ...
          <div className="flex flex-col">
            <span
              className={[ "text-xl font-bold", streak === 0 ? "text-gray-400" : "" ].join(" ")}
            >
              {streak}
            </span>
        ...
        <div className="flex gap-2 rounded-2xl border-2 border-gray-200 p-2 md:gap-3 md:px-6 md:py-4">
          ...
          <div className="flex flex-col">
            <span
              className={[ "text-xl font-bold", top3Finishes === 0 ? "text-gray-400" : "" ].join(" ")}
            >
              {top3Finishes}
            </span>
            <span className="text-sm text-gray-400 md:text-base">
